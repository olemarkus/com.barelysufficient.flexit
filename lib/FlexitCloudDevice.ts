...
import { FlexitNordicBaseDevice } from './FlexitNordicBaseDevice';
import { FlexitCloudClient, AuthenticationError, CloudToken } from './flexitCloudClient';

/**
 * Shared Flexit Go cloud device. Holds the transport-specific behaviour — token
 * restore/persist and registry registration over the cloud client — so the Nordic and
 * EcoNordic cloud devices never duplicate it.
 */
export class FlexitCloudDevice extends FlexitNordicBaseDevice {
