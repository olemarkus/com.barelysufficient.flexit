...
/**
 * Shared BACnet (local) device. Holds the transport-specific behaviour — registry
 * registration, slow/failed capability-action handling and legacy connection-setting
 * normalization — so the Nordic and EcoNordic local devices never duplicate it.
 */
export class FlexitBacnetDevice extends FlexitNordicBaseDevice {
