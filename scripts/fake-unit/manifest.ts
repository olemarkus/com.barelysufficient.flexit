...
export const SUPPORTED_POINTS: SupportedPoint[] = [
  ...
  point('fan_profile_supply_high', 'ANALOG_VALUE', 1835, 'real', 'RW', 'observed', 'Setpoint supply air HIGH', {
    min: 80,
    max: 100,
    units: '%',
    requiresPriority13: true,
  }),
  point('fan_profile_supply_home', 'ANALOG_VALUE', 1836, 'real', 'RW', 'observed', 'Setpoint supply air HOME', {
    min: 56,
    max: 100,
    units: '%',
    requiresPriority13: true,
  }),
  point('fan_profile_supply_away', 'ANALOG_VALUE', 1837, 'real', 'RW', 'observed', 'Setpoint supply air AWAY', {
    min: 30,
    max: 80,
    units: '%',
    requiresPriority13: true,
  }),
  point('fan_profile_supply_fireplace', 'ANALOG_VALUE', 1838, 'real', 'RW', 'observed', 'Setpoint supply air FIREPLACE', {
    min: 30,
    max: 100,
    units: '%',
    requiresPriority13: true,
  }),
  point('fan_profile_supply_cooker', 'ANALOG_VALUE', 1839, 'real', 'RW', 'observed', 'Setpoint supply air COOKER', {
    min: 30,
    max: 100,
    units: '%',
    requiresPriority13: true,
  }),
  point('fan_profile_extract_high', 'ANALOG_VALUE', 1840, 'real', 'RW', 'observed', 'Setpoint exhaust air HIGH', {
    min: 79,
    max: 100,
    units: '%',
    requiresPriority13: true,
  }),
  point('fan_profile_extract_home', 'ANALOG_VALUE', 1841, 'real', 'RW', 'observed', 'Setpoint exhaust air HOME', {
    min: 55,
    max: 99,
    units: '%',
    requiresPriority13: true,
  }),
  point('fan_profile_extract_away', 'ANALOG_VALUE', 1842, 'real', 'RW', 'observed', 'Setpoint exhaust air AWAY', {
    min: 30,
    max: 79,
    units: '%',
    requiresPriority13: true,
  }),
  point('fan_profile_extract_fireplace', 'ANALOG_VALUE', 1843, 'real', 'RW', 'observed', 'Setpoint exhaust air FIREPLACE', {
    min: 30,
    max: 100,
    units: '%',
    requiresPriority13: true,
  }),
  point('fan_profile_extract_cooker', 'ANALOG_VALUE', 1844, 'real', 'RW', 'observed', 'Setpoint exhaust air COOKER', {
    min: 30,
    max: 100,
    units: '%',
    requiresPriority13: true,
